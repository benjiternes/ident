...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{img/BT}}]{Benjamin Ternes}
\blindtext
\end{IEEEbiography}
...
% simpler here.)
%\begin{biography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{img/BT}}]{Benjamin Ternes}\blindtext \end{biography}%
